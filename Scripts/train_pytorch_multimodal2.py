...
def train_pytorch_multimodal(
    ...
    if os.path.exists(save_model_path):
        ...
        print(f"[INFO] Loaded best model from {save_model_path}")
    else:
...
if __name__ == "__main__":
    ...
    try:
        ...
        mm_metrics = train_pytorch_multimodal(
            ...
            num_epochs=10,
            lr=1e-4,
            device_str="cuda",  # use "cpu" if you don't have a GPU
            save_model_path=r"C:\Users\Owner\OneDrive - University of Massachusetts Dartmouth\Documents\Capstone\Results\best_multimodal.pth",
            patience=6
        )
